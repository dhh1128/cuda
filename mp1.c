...
int main(int argc, char ** argv) {
	...
	dim3 blocksInGrid((inputLength - 1)/256 + 1, 1, 1);
  	dim3 threadsInBlock(256, 1, 1);

    
    wbTime_start(Compute, "Performing CUDA computation");
    // Launch the GPU Kernel here
    vecAdd<<<blocksInGrid, threadsInBlock>>>(deviceInput1, deviceInput2, deviceOutput, inputLength);
